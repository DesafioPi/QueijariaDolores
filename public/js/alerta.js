...
function obterdados(idSala) {
    fetch(`/medidas/tempo-real/${idSala}`)
        ...
        .catch(function (error) {
            console.error(`Erro na obtenção dos dados do sala p/ gráfico: ${error.message}`);
        });
...
function alertar(resposta, idSala) {
    ...
    if (document.getElementById(`temp_sala_${idSala}`) != null) {
        document.getElementById(`temp_sala_${idSala}`).innerHTML = temp + "°C";
    }
